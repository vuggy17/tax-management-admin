...
const imgUrl = "/img/login-background.jpg";
...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center w-screen h-screen " style={{ ...loginStyle }}>
      <div className="bg-gray-50 flex flex-col justify-between " style={{
        width: 600
      }}>
        <div>
          <div className="pt-10 w-full">
            <img width="200px" className="mx-auto" src={logo} alt="drdongphuong" />
          </div>
          <div className="mt-12 flex flex-col items-start px-6 w-full md:w-2/3 m-auto">
        ...
        <div className="bg-white w-full text-xs py-4 flex items-center justify-center">
          <span className="text-xs text-gray-400 mr-1 ">Copyright © 2023 </span>
